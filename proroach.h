...
FUNCAO VAZIA printVector COM CARACTER type E_TAMBEM VAZIO COMO_PONTEIRO vet E_TAMBEM INTEIRO elem COMO_ARGUMENTOS INICIO
    CARACTER mascara COMO_VETOR_DE 6 ELEMENTOS FIM_DE_COMANDO
    SE type IGUAL_A 'i' ENTAO
       PARA INTEIRO i COMECANDO_EM 0 ALEM_DISSO i MENOR_QUE elem ALEM_DISSO i INCREMENTADO FAZER
